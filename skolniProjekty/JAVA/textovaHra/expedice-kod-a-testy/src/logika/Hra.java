...
public class Hra implements IHra {
    ...
    public Hra() {
        ...
        platnePrikazy.vlozPrikaz(new PrikazHadanka(herniPlan));
    ...
    public String vratUvitani() {
        return "Vitej na dobrodruzne expedici!\n" +
                ...
                herniPlan.getInventar().dlouhyPopis();
    }
    ...
    /**
     * Nastavuje hodnotu promenne epilog.
     * @param epilog Hodnote, podle ktere se nastavi promenna epilog.
     */
